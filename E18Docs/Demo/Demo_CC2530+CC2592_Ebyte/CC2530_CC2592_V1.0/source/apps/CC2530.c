...
//#define TX_ADDR             0x2543  // 发送地址
#define RX_ADDR             0xBEEF  // 接收地址
//#define RX_ADDR             0x2520  // 接收地址
//#define RX_ADDR             0x2543  // 接收地址

#define RF_CHANNEL          11      // 2.4 GHz RF channel 11 - 26  步进为5MHZ
...
static void RF_Initial(uint8 mode)
{
    ...
    halRfSetTxPower(4);                     // 设置输出功率为20dbm
...
//    basicRfSendPacket(RX_ADDR, pTxData, SEND_LENGTH);
    {
        SendCnt++;
