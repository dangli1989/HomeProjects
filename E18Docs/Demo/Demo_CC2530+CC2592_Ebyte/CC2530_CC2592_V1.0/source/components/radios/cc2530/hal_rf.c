...
// CC2590-CC2591-RFX2401C support
#define INCLUDE_PA 2592

#if INCLUDE_PA==2591  //PA:cc2591
...
#elif INCLUDE_PA==2401  //PA:rfx2401c
...
// TX power values
#define CC2530_2401_TXPOWER_0_DBM       0x25
#define CC2530_2401_TXPOWER_13_DBM      0x85
#define CC2530_2401_TXPOWER_16_DBM      0xA5
#define CC2530_2401_TXPOWER_18_DBM      0xC5
#define CC2530_2401_TXPOWER_20_DBM      0xE5
...
#else // dummy macros when not using PA
...
#elif INCLUDE_PA==2401
    case HAL_RF_TXPOWER_0_DBM: n = CC2530_2401_TXPOWER_0_DBM; break;
    case HAL_RF_TXPOWER_13_DBM: n = CC2530_2401_TXPOWER_13_DBM; break;
    case HAL_RF_TXPOWER_16_DBM: n = CC2530_2401_TXPOWER_16_DBM; break;
    case HAL_RF_TXPOWER_18_DBM: n = CC2530_2401_TXPOWER_18_DBM; break;
    case HAL_RF_TXPOWER_20_DBM: n = CC2530_2401_TXPOWER_20_DBM; break; 
#elif INCLUDE_PA==2592
